          ...
          return Container(
            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    ...
                    SafeArea(
                      ...
                      child: IconButton(
                        onPressed: () {
                          context.read<HomeBloc>().add(ToggleDistanceFilterEvent());
                        },
                        icon: Icon(
                          context.read<HomeBloc>().showDistanceFilter ? Icons.filter_alt : Icons.filter_alt_outlined,
                    ...
                    SafeArea(
                      ...
                      child: IconButton(
                        onPressed: () {
                          cont.read<HomeBloc>().bidRideTop =
                              (size.height) - (size.height * 0.67);
                          cont.read<HomeBloc>().add(UpdateEvent());
                ...
                // Conditionally show distance selector based on state
                if (cont.read<HomeBloc>().showDistanceFilter) ...[
                  SizedBox(
